...
const data = {
  ...
  knowledgeBase: [
    {
      ...
      img: ('@src/assets/images/illustration/sales.svg').default,
    ...
    },
    {
      ...
      img: ('@src/assets/images/illustration/marketing.svg').default,
    ...
    },
    {
      ...
      img: ('@src/assets/images/illustration/api.svg').default,
      title: 'API Questions',
    ...
    },
    {
      ...
      img: ('@src/assets/images/illustration/personalization.svg').default,
    ...
    },
    {
      ...
      img: ('@src/assets/images/illustration/email.svg').default,
    ...
    },
    {
      ...
      img: ('@src/assets/images/illustration/demand.svg').default,
  ...
  questionData: {
    ...
    // ! Here we have used  for image source but in API it shall be URL of live image, this is just for demo purpose
    content: `<p>It has been said that astronomy is a humbling and character-building experience. There is perhaps no better demonstration of the folly of human conceits than this distant image of our tiny world. To me, it underscores our responsibility to deal more kindly with one another, and to preserve and cherish the pale blue dot, the only home we’ve ever known. The Earth is a very small stage in a vast cosmic arena. Think of the rivers of blood spilled by all those generals and emperors so that, in glory and triumph, they could become the momentary masters of a fraction of a dot. Think of the endless cruelties visited by the inhabitants of one corner of this pixel on the scarcely distinguishable inhabitants of some other corner, how frequent their misunderstandings, how eager they are to kill one another, how fervent their hatreds.</p><img class="img-fluid w-100 my-1 rounded" src="${
      ('@src/assets/images/pages/kb-image.jpg').default
    }" /><h5 class='my-1'>Houston</h5><p>that may have seemed like a very long final phase. The auto targeting was taking us right into a … crater, with a large number of big boulders and rocks … and it d …flying manually over the rock field to find a reasonably good area.</p><ul class="list-group list-group-circle ms-2 mt-2"><li class="list-group-item"><a class="text-body" href="/" rel="noopener noreferrer" >I am a stranger. I come in peace. Take me to your leader and there will be a massive reward for you in eternity.</a></li><li class="list-group-item"><a class="text-body" href="/" rel="noopener noreferrer" >It’s just mind-blowingly awesome. I apologize, and I wish I was more articulate, but it’s hard to be articulate when your mind’s blown—but in a very good way.</a></li><li class="list-group-item"><a class="text-body" href="/" rel="noopener noreferrer" >A good rule for rocket experimenters to follow is this</a></li></ul>`
  }
}
