      ...
      attachments: [
        {
          ...
          img: ('@src/assets/images/icons/file-icons/doc.png').default
        },
        {
          name: 'app.js',
          img: ('@src/assets/images/icons/file-icons/js.png').default
        }
      ],
      comments: [
        {
          name: 'Joey Tribbiani',
          img: ('@src/assets/images/portrait/small/avatar-s-3.jpg').default,
        ...
        {
          name: 'Monica Geller',
          img: ('@src/assets/images/portrait/small/avatar-s-6.jpg').default,
          comment: 'Complete this on priority'
        }
      ],
      assignedTo: [
        ...
        {
          title: 'Pheobe Buffay',
          img: ('@src/assets/images/portrait/small/avatar-s-2.jpg').default
        }
      ]
    },
    {
      ...
      labels: ['Images'],
      boardId: 'todo',
      coverImage: ('@src/assets/images/slider/03.jpg').default,
      description: 'lorem',
      dueDate: dayAfterTomorrow,
      ...
      attachments: [
        {
          name: 'book.pdf',
          img: ('@src/assets/images/icons/file-icons/pdf.png').default
        },
        {
          name: 'app.js',
          img: ('@src/assets/images/icons/file-icons/js.png').default
      ...
      assignedTo: [
        {
          title: 'Rachel Green',
          img: ('@src/assets/images/portrait/small/avatar-s-4.jpg').default
        }
      ]
    },
    {
      ...
      attachments: [
        {
          name: 'list.txt',
          img: ('@src/assets/images/icons/file-icons/txt.png').default
        },
        {
          name: 'pdf.png',
          img: ('@src/assets/images/icons/file-icons/pdf.png').default
