  ...
  emails: [
    {
      ...
      from: {
        ...
        name: 'Tommy Sicilia',
        avatar: ('@src/assets/images/avatars/1.png').default
      },
      to: [
        {
          name: 'me',
      ...
      attachments: [
        {
          fileName: 'log.txt',
          thumbnail: ('@src/assets/images/icons/txt.png').default,
          url: '',
          size: '5mb'
        },
        {
          fileName: 'performance.xls',
          thumbnail: ('@src/assets/images/icons/xls.png').default,
          url: '',
          size: '10mb'
        }
      ],
    ...
    },
    {
      ...
      from: {
        ...
        name: 'Tressa Gass',
        avatar: ('@src/assets/images/avatars/2.png').default
      },
      to: [
        {
          name: 'me',
    ...
    },
    {
      ...
      from: {
        ...
        avatar: ('@src/assets/images/avatars/3.png').default
      },
      to: [
        {
          name: 'me',
    ...
    },
    {
      ...
      from: {
        ...
        name: 'Louetta Esses',
        avatar: ('@src/assets/images/avatars/4.png').default
      },
      to: [
        {
          name: 'me',
      ...
      attachments: [
        {
          fileName: 'report.doc',
          thumbnail: ('@src/assets/images/icons/doc.png').default,
          url: '',
          size: '32mb'
        }
      ],
    ...
    },
    {
      ...
      from: {
        ...
        name: 'Bobbie Posvner',
        avatar: ('@src/assets/images/avatars/11.png').default
      },
      to: [
        {
          name: 'me',
    ...
    },
    {
      ...
      from: {
        ...
        name: 'Rebecca Gilder',
        avatar: ('@src/assets/images/avatars/6.png').default
      },
      to: [
        {
          name: 'me',
    ...
    },
    {
      ...
      from: {
        ...
        avatar: ('@src/assets/images/avatars/9.png').default
      },
      to: [
        {
          name: 'me',
    ...
    },
    {
      ...
      from: {
        ...
        avatar: ('@src/assets/images/avatars/7.png').default
      },
      to: [
        {
          name: 'me',
      ...
      attachments: [
        {
          ...
          thumbnail: ('@src/assets/images/icons/js.png').default,
          url: '',
          size: '29mb'
        }
      ],
    ...
    },
    {
      ...
      from: {
        ...
        avatar: ('@src/assets/images/avatars/10.png').default
      },
      to: [
        {
          name: 'me',
    ...
    },
    {
      ...
      from: {
        ...
        avatar: ('@src/assets/images/avatars/8.png').default
      },
      to: [
        {
          name: 'me',
      ...
      bcc: [],
      message:
        '<p>Hey John, </p><p>hightoby Maja vindicatorship unglobe poduran bronchodilatation uncontorted underwarden cyclometric orgiacs tigerhearted upscale curatize Scylliorhinidae slick unisolated nanocephalous cuirassier heartwise Venusian titanitic ment antirestoration toluido</p><p>Trematosaurus procreant ethos pessimistic antiselene pisk Amphipneusta anconad Corchorus unswabbed sizable Balanites sardonical shovelbill trammeler carpetwork rhexis remade myelinated right bounteous unsin retroduction Montanist</p>',
      attachments: [],
      isStarred: true,
      labels: ['personal'],
