...
const DataTableServerSide = ({setTypeAlert, setHeadAlert, setTitleAlert, setShowAlert,setadmincount,ref_clicked,setallPermissions}) => {
  ...
  const [SelectedRowRole, setSelectedRowRole] = useState(null)
...
// Delete_Admin=19
  ...
  function requestPermissions(){
    ...
    .then(function (response) {
      ...
      setcan_view_perm(allPermissions_table.includes(20))
      setcan_edit_perm(allPermissions_table.includes(17))
      setcan_delete_perm(allPermissions_table.includes(19))
  ...
  const handleConfirmDelete = () => {
    ...
    var config = {
      method: 'delete',
      url: `${domain_url}/users/deleteuser?id=${selectedRowId}`,
      headers: { 
        'Authorization': `Bearer ${token}`, 
      },
      data : data
    ...
    .then(function (response) {
      ...
      if (response.status == "200"){
        ...
        setTitleAlert("تم مسح المستخدم بنجاح.")
        setHeadAlert("")
        setShowAlert(true)
        reload_table()
      } else{ 
                setTypeAlert("Fail")
        setTitleAlert("لم يتم مسح المستخدم بشكل صحيح.")
  ...
  const UserPermission = () => {
    ...
    return (<Modal aria-labelledby="contained-modal-title-vcenter" centered show={showPermission} onHide={handleClosePermission}>
      ...
      <div className="col-6">
          ...
          { true && (
              <FormPermissionComponent handleClosePermission={handleClosePermission} permission_user_id={permission_user_id}  setTypeAlert={setTypeAlert} setHeadAlert = {setHeadAlert} setTitleAlert = {setTitleAlert} setShowAlert = {setShowAlert} />
            )
          }
  ...
  /////////////end admin user
    ...
    const editUserRowId = (id,email,name,phone,role) => {
      console.log("edit")
      console.log("444444444",id,email,name)
      setSelectedRowId(id)
      setSelectedRowEmail(email)
      setSelectedRowName(name)
      setSelectedRowPhone(phone)
    ...
    const EditUser = () => {
      ...
      return (<Modal aria-labelledby="contained-modal-title-vcenter" centered show={showEditUser} onHide={handleCloseEditUser} setTypeAlert={setTypeAlert}  setHeadAlert={setHeadAlert} setTitleAlert={setTitleAlert}  setShowAlert={setShowAlert}>
        ...
        <div className="col-6">
            ...
            <Modal.Body className='scrollable-user-content'>
            { true && (
                <FormComponent handleCloseEditUser={handleCloseEditUser} RowId={selectedRowId} RowEmail={SelectedRowEmail} RowName={SelectedRowName}  RowPhone={SelectedRowPhone} RowRole={SelectedRowRole} setTypeAlert={setTypeAlert}  setHeadAlert={setHeadAlert} setTitleAlert={setTitleAlert}  setShowAlert={setShowAlert} reload_table={reload_table}/>
              )
            }
  ...
  return (
    ...
    <div className='react-dataTable '>
      <DataTable 
        ...
        noDataComponent={<EmptyTable obj = "admin" />}
