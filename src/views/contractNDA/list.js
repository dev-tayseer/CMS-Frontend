      ...
      <div className="container-fluid pe-md-5 ps-md-5 pe-1 ps-1">
          ...
          */}
              ...
              {can_add_contract && (
                ...
                <Col className='d-flex align-items-center justify-content-sm-start p-0 mt-4  mt-md-0 '>
                  <Button.Ripple target='_blank' outline className="btn button1 px-3 ms-md-3 py-2" href="/AddContractNDA">
                    <span className='color-5F605F f-s-14px font-cairo f-w-700 mt-2 mt-md-0' >إضافة عقد NDA</span>
                    <Plus className="ps-5" />
                  </Button.Ripple>
                </Col>
              )
        ...
        <Row>
          <div className='col-md-6 ps-md-0 ps-4  pe-0 mt-4 d-flex flex-start'>
            <div className='f-w-700 f-s-24px color-5F605F font-cairo '>عقود NDA</div>
          </div>
        </Row>
