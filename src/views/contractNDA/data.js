      ...
      return (
        <div className='d-flex justify-content-end w-100 last-col'>
          ...
          {/* {can_view_contract && (
            ...
            <a title='عرض' target='_blank' className="blue-color-icon blue-color-icon-h ps-3" href={`ContractNDADetails?id=${row.id}`}><Eye3 size={20} /></a>
          )} */}

          {can_edit_contract && (
            <a title='تعديل' target='_blank' className="blue-color-icon blue-color-icon-h ps-3" href={`AddContractNDA?id=${row.id}`}><Edit3 size={20} /></a>
          )}
