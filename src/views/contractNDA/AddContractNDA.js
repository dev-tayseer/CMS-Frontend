...
const AddContractNDA = () => {
  ...
  const [signup_date, setsignup_date] = useState(false)
  const [signup_dateValidation, setsignup_dateValidation] = useState(false)
  ...
  const getCompanyById = async (company_id) => {
    ...
    try {
      ...
      const result = await axios.get(`${domain_url}/Contract/AddContractsNDA/?id=${company_id}`, config)
      ...
      setsignup_date(new Date(data.signup_agreement_date))
      setcommercial_number2(data.commercial_number2)
      setValue('commercial_number2', data.commercial_number2)
      setUnified_No(data.Unified_No)
      setValue('Unified_No', data.Unified_No)
  ...
  if (add['current'] === true) {
    ...
    SignupSchema = yup.object().shape({
      ...
      //       console.log(value.id == "1", "value.id ==")
      //       if (value.id != typeValueId) {
      //         console.log(value.id, "VVVVVVVVVVVVVVVVVVVVVVVVVVVVVVVV")
      //         if (value.id == "1") {
      //           setbill_type("Egar")
      //           setcan_add_bill(true)
      //           setcan_add_advancebtn(true)
  ...
  const saveDataCompany = async () => {
    ...
    try {
      if (add['current'] === true) {
        ...
        axios({
          method: "post",
          url: `${domain_url}/Contract/AddContractsNDA/`,
          data: bodyFormData,
          headers: {
          ...
          .then(function (response) {
            ...
            if (response.data[0]["succse"] === 0) {
              ...
              setShowAlert(true)
              if (add['current'] === true) {
                navigate('/ContractNDA?success=added')
              } else {
                navigate('/ContractNDA?success=edited')
        ...
        axios({
          method: "put",
          url: `${domain_url}/Contract/AddContractsNDA/?id=${company_Id}`,
          data: bodyFormData,
          headers: {
            "Content-Type": "multipart/form-data",
            Authorization: `Bearer ${token}`,
  ...
  const saveDataCompanynew = async () => {
    ...
    if (add['current'] === true) {
      ...
      bodyFormData.append('signup_agreement_date', signup_date)
      ...
      if (add['current'] === true) {
        ...
        axios({
          ...
          .then(function (response) {
            console.log(response, "eeee")
            console.log(response.data, "777")
            console.log(response.data[0].message.succse, "***9")
            // console.log(response.data.message[0]["succse"],"999")
            if (response.data[0].message["succse"] === 0) {
              console.log("not 2000")
              setTypeAlert("Fail")
              setTitleAlert(`${response.data[0].message.succse}`)
  ...
  const onSubmit = data => {
    ...
    // console.log(renewDurationValidation)
    // console.log(durationValidation)
    // console.log(companyValidation)
    // console.log(departmentValidation)
    // console.log(user_dep_Validation)
    // console.log(notesValidation)
    // console.log(date_fromValidation)
    // console.log(date_toValidation)

    if (add['current']) {
      console.log("biba2")
      if ((nameValidation & durationValidation & renewDurationValidation & companyValidation & departmentValidation & user_dep_Validation & notesValidation & !date_fromValidation & !date_toValidation & !signup_dateValidation)) {
        console.log("boom")
        saveDataCompanynew()
      }
    }
      ...
      console.log(date_fromValidation)
      console.log(date_toValidation)
      console.log((nameValidation & renewDurationValidation & durationValidation & companyValidation & departmentValidation & user_dep_Validation & notesValidation & date_fromValidation & date_toValidation), "be5")
      if ((nameValidation & renewDurationValidation & durationValidation & companyValidation & departmentValidation & user_dep_Validation & notesValidation & !date_fromValidation & !date_toValidation & !signup_dateValidation)) {
        saveDataCompanynew()
      }
    }
  }
  ...
  function handleClickSavenew() {
    ...
    let date_from_input = document.getElementsByName("date_from")[0]
    let date_to_input = document.getElementsByName("date_to")[0]
    let signup_date_input = document.getElementsByName("signup_date")[0]
    let date_from = date_from_input.value
    let date_to = date_to_input.value

    console.log(signup_date_input.value, "signup_date_inputsignup_date_inputsignup_date_input")

    if (signup_date_input.value == "" || signup_date_input.value == undefined) {
      console.log("notcalid")
      setsignup_dateValidation(true)
      setsignup_date("")
      signup_date_input.classList.add("form-control")
      signup_date_input.classList.add("form-control-lg")
      signup_date_input.classList.add("is-invalid")




    } else {
      setsignup_dateValidation(false)
      setsignup_date(signup_date_input.value)
      signup_date_input.classList.add("form-control")
      signup_date_input.classList.add("form-control-lg")
      signup_date_input.classList.remove("is-invalid")
  ...
  function handleChangeSignupDate(date) {
    try {
      let datestr = date.toString();
      let date_from_input = document.getElementsByName("signup_date")[0]
  ...
  function handleDeleteFile(name, e, id = '') {
    ...
    if (id != '') {
      ...
      console.log(combinedArray,"combinedArray with id")
      ...
      console.log(backend_updateFiles,"backend_updateFiles")
      console.log(backend_updateFiles1,"backend_updateFiles1")

      console.log(combinedArray,"combinedArray without id")
      setbackend_files(combinedArray)
    }
  ...
  return (
        ...
        <div className="container-fluid pe-md-5 ps-md-4 pe-1 ps-1">
          ...
          <div className="row pt-3 pt-md-5 pb-3 header-home-small">
            <div className="col-md-9 ps-md-0 ps-3">
              ...
              <>
                <a href="/ContractNDA">
                  <span className='ps-md-3 headerContractObj'> العقود NDA</span>
                </a>
                <span className='ps-md-3'><ArrowIcon /></span>
              </>

              {(add['current']) ?
                <span className='px-md-3 headerContractObj headerContractObjColored p-2 '> إضافة عقد NDA</span>
                :
                <span className='px-md-3 headerContractObj headerContractObjColored p-2 '> تعديل العقد NDA</span>
              }
            </div>
    ...
    <Button.Ripple onClick={() => BillData()} target='_blank' outline className="btn button1 px-5 py-2" >
          ...
          <div className='d-md-flex justify-content-between'>
            {(add['current']) ? <div className='addPageHeader pt-4 ps-0 ms-0'>إضافة عقد NDA</div> : <div className='addPageHeader pt-4 ps-0 ms-0'>تعديل العقد NDA</div>}
            {!(add['current']) && (
          ...
          <Form onSubmit={handleSubmit(onSubmit)}>
            <div className="container-fluid mt-5 pt-2 pb-5 mb-5 background-FFFFFF borderRadius-8">
                ...
                <Col sm='4' className='mb-4 form-group bmd-form-group'>
                  ...
                  {add['current'] ? (
                    ...
                    <Controller
                      ...
                      control={control}
                      render={({ field }) => <Input disabled="true" {...field} placeholder='أدخل فترة العقد' bsSize='lg' className={add['current'] ? 'h-60 f-s-12px f-w-700 bg-F7FAF7' : 'h-60 f-s-12px f-w-700 border-A0A8B3 bg-F9FAFB'} invalid={errors.duration && true} />}
                    />
                  )}
                  {errors.duration && <FormFeedback>{errors.duration.message}</FormFeedback>}
              ...
              />
                ...
                {add['current'] === false && (
                  <Col sm='4' className='mb-4 form-group bmd-form-group'>
                    <SelectWithValidation1 isDisabled={true} defaultValue={contract_statusValue} id_name='contract_status' title='حالة العقد' control={control} errors_check={errors.contract_status} loadOptionsDB={contract_statusData} />
                  </Col>
                )}
                ...
                {can_add_duration && (
                  <Col sm='4' className='mb-4 form-group bmd-form-group'>
                    ...
                    <Controller
                      ...
                      control={control}
                      render={({ field }) => <Input  {...field} placeholder='مدة الإنذار' bsSize='lg' className={add['current'] ? 'h-60 f-s-12px f-w-700 bg-F7FAF7' : 'h-60 f-s-12px f-w-700 border-A0A8B3 bg-F9FAFB'} disabled invalid={errors.renewDuration && true} />}
                    />
               ...
               <Col sm='4' className='mb-4 form-group bmd-form-group'>
                ...
                {/* <Row className='p-0 m-0'>
                  ...
                  <Col sm='4' className='mb-4 form-group bmd-form-group'>
                    <SelectWithValidation1 defaultValue={countryValue} id_name='country' title='البلد' control={control} errors_check={errors.country} loadOptionsDB={CountryData} change="Country" />
                  </Col>
            ...
            <div className="row flex-column-reverse flex-sm-row pt-2 mb-2">
              <Col md='6' className='mb-2'>
                ...
                {
                  add['current'] === true ? (
                    <Button onClick={handleClickSavenew} className={(nameValidation & renewDurationValidation & durationValidation & companyValidation & departmentValidation & notesValidation & !date_fromValidation & !date_toValidation & !date_toValidation & signup_dateValidation) ? 'text-center btn-style color-5F605F d-block p-2 w-100 f-w-700 f-s-20px background-FBB827 font-Cairo' : 'text-center btn-style color-BDBFBD d-block p-2 w-100 f-w-700 f-s-20px background-FFF5E0 font-Cairo'} color='white' outline type='submit'> حفظ العقد  </Button>

                  ) : (
                    <Button onClick={handleClickSavenew} className={(nameValidation & renewDurationValidation & durationValidation & companyValidation & departmentValidation & notesValidation & !date_fromValidation & !date_toValidation & signup_dateValidation) ? 'text-center btn-style color-5F605F d-block p-2 w-100 f-w-700 f-s-20px background-FBB827 font-Cairo' : 'text-center btn-style color-BDBFBD d-block p-2 w-100 f-w-700 f-s-20px background-FFF5E0 font-Cairo'} color='white' outline type='submit'> حفظ العقد  </Button>
