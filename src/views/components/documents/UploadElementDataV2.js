...
const UploadElementDataV2 = ({ main, render_pdf, handleRemoveAllFiles, files, setFiles, fileUrlExists, fileUrl }) => {
    // ** State
...
export default UploadElementDataV2
