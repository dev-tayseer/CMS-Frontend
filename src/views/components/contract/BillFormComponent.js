...
import { element } from 'prop-types'
 ...
 export default function BillFormComponent({handleCloseTimeExtension,selectedRowId,setTypeAlert, setHeadAlert, setTitleAlert, setShowAlert , typeValue , billData , setbillData , setBillRecExists , can_add_advance , setcan_add_advance , can_add_late , setcan_add_late  ,  via_default   , setcan_add_advancebtn , setcan_add_latebtn}){
