...
const AddContract = () => {
  ...
  const [sadad_cycleValidation, setsadad_cycleValidation] = useState(false)
  ...
  const getCompanyById = async (company_id) => {
    ...
    try {
      ...
      setsadad_cycle(data.sadad_cycle)
      ...
      { JSON.stringify(sadad_cycleValidation) }
  ...
  // console.log(departmentValidation , notesValidation , !date_fromValidation , !date_toValidation , commercial_numberValidation , total_amountValidation , sadad_cycleValidation , annual_value_sadadValidation),"all data")
  // console.log((departmentValidation & notesValidation & !date_fromValidation & !date_toValidation & commercial_numberValidation & total_amountValidation & sadad_cycleValidation & annual_value_sadadValidation),'all value')
  ...
  SignupSchema = yup.object().shape({
    ...
    sadad_cycle: yup.string().test({
      ...
      test(value, ctx) {
        ...
        if (value === null | value === "") {
          setsadad_cycleValidation(false)
          return ctx.createError({ message: 'الرجاء ملء هذه الخانة مطلوبة' })
        }
  ...
  const onSubmit = data => {
    ...
    // if (add['current']) {
    //   if ((durationValidation & departmentValidation & notesValidation & !date_fromValidation & !date_toValidation & commercial_numberValidation & total_amountValidation & sadad_cycleValidation & annual_value_sadadValidation)) {
    //     console.log("submir")
    //     saveDataCompany()
    //   }
    // }
    // else {
    //   if ((departmentValidation & notesValidation & !date_fromValidation & !date_toValidation & commercial_numberValidation & total_amountValidation & sadad_cycleValidation & annual_value_sadadValidation)) {
    //     saveDataCompany()
    //   }
    // }
    console.log(data)
    ...
    if (add['current']) {
      if ((durationValidation & departmentValidation & notesValidation & departmentValidation & user_dep_Validation & !date_fromValidation & !date_toValidation & commercial_numberValidation & total_amountValidation & sadad_cycleValidation & annual_value_sadadValidation)) {
        console.log("submir")
        setidentity_number(data.identity_number ?? "")
        setidentity_number_systematic(data.identity_number_systematic ?? "")
        setidentity_number_gulf(data.identity_number_gulf ?? "")
      ...
      if ((departmentValidation & notesValidation & !date_fromValidation & !date_toValidation & user_dep_Validation & commercial_numberValidation & total_amountValidation & sadad_cycleValidation & annual_value_sadadValidation)) {
