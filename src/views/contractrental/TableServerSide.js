...
const DataTableServerSide = ({setTypeAlert, setHeadAlert, setTitleAlert, setShowAlert,setdepartmentCount,setallPermissions}) => {
      ...
      <div className="col-6">
          ...
          <Modal.Body>
                  ...
                  <div className="row">
                      ...
                      هل انت متأكد من حذف عقد الإيجار؟
                      </p>
  ...
  function exportExcelAll(){
    ...
    var config = {
      method: 'get',
      responseType: 'blob',
      url: `${domain_url}/Contract/excel?type_of_auction=1`,
      headers: { 
        'Authorization': `Bearer ${token}`,
  ...
  return (
    ...
    <div className="container-fluid table-header-bordered ps-xl-5 ps-3 pt-4 mt-3   ">
      ...
      <Row className=' mt-1  p-0'>
          ...
          <Col className='col-md-3 col-12 text-md-end'>

          </Col>
          <Col className='col-md-6 pt-1 col-12  px-0 p-md-0 d-flex justify-content-end '>
          <AsyncSelect
          defaultOptions
          isClearable={false}
          name='db-react-select'
          className='react-select  react-select-contract ps-md-1 select-full   pt-2 pt-md-1  '
    ...
    <div className='react-dataTable '>
      <DataTable 
        ...
        noDataComponent={<EmptyTable obj = "contractrental" />}
