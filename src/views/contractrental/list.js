    ...
    <div className="theme-content px-0 px-md-5 ms-xl-5">
      ...
      <div className="container-fluid pe-md-5 ps-md-5 pe-1 ps-1">
        ...
        <Row className='container-fluid pe-0 ps-4 ps-md-0 mt-2'>
          ...
          <HomeHeader headerContract="نظام عقد الإيجار العقود" headerContractObj="عقود الإيجار" />
          </Col>
          {can_add_department && (

          
            <Col className='col-md-6 col-12 text-md-end mt-sm-0 mt-1 pt-md-5 pt-2  ps-xl-5 ps-3 col-8  col-md-6 pe-2'>
              <Button.Ripple target='_blank' outline className="btn button1 px-5 py-2" href="/addContractRental">
                <span className='color-5F605F f-s-14px font-cairo f-w-700 pe-2' >إضافة عقد الإيجار</span>
                <Plus className="ps-5" />
              </Button.Ripple>
            </Col>
          )}
        ...
        <div className='col-md-12 ps-xl-0  pe-xl-0 ps-3 mt-4 d-flex flex-start'>
            <div className='f-w-700 f-s-24px color-5F605F font-cairo '>عقود الإيجار</div>
            <div className='d-none ms-3 color-D99F22 f-s-16px f-w-700 background-FFFDF7 px-4 mt-1 py-1 borderRadius-16px'>{departmentCount} عقد الإيجار</div>
        </div>
        </Row>
