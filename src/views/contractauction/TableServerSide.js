...
const DataTableServerSide = ({setTypeAlert, setHeadAlert, setTitleAlert, setShowAlert,setdepartmentCount,setallPermissions}) => {
      ...
      <div className="col-6">
          ...
          <Modal.Body>
                  ...
                  <div className="row">
                      ...
                      هل انت متأكد من حذف عقد المزاد؟
                      </p>
  ...
  function exportExcelAll(){
    ...
    var config = {
      method: 'get',
      responseType: 'blob',
      url: `${domain_url}/Contract/excel?type_of_auction=2`,
      headers: { 
        'Authorization': `Bearer ${token}`,
  ...
  return (
    ...
    <div className='react-dataTable '>
      <DataTable 
        ...
        noDataComponent={<EmptyTable obj = "contractauction" />}
