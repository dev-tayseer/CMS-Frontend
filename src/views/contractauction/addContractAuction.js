...
const AddContract = () => {
  ...
  const getCompanyById = async (company_id) => {
    ...
    try {
      ...
      // const result = await axios.get(`http://127.0.0.1:8000/Contract/AddContractsAuction/?id=${company_id}`, config)
      ...
      console.log(data.type_of_Auction, "data.type_of_Auction")
      ...
      setValue('identity_number_systematic', data.identity_number_systematic)
      setValue('identity_number_gulf', data.identity_number_gulf)
      ...
      setValue('setidentity_number_leaseholder', data.setidentity_number_leaseholder)
      setValue('setidentity_number_systematic_leaseholder', data.setidentity_number_systematic_leaseholder)
      setValue('setidentity_number_gulf_leaseholder', data.setidentity_number_gulf_leaseholder)
  ...
  const loadOptionsNationality = async () => {
    ...
    // const data = await axios.get(`http://127.0.0.1:8000/Nationalities/NationalitiesView/`, config).then(res => {
  ...
  useEffect(() => {
    try {
      console.log(type_of_AuctionValueId, "type_of_AuctionValueId")
    ...
    total_amount: yup.string().test({
      ...
      test(value, ctx) {
        ...
        if (value === null | value === "") {
          ...
          if (value === false) {
            settotal_amountValidation(false)
            return ctx.createError({ message: 'الرجاء إدخال الرقم بشكل صحيح' })
          }
        }
    ...
    tenant_nationality: yup.mixed().test({
      ...
      test(value, ctx) {
        ...
        if (checkInputUndefined(value)) {
          ...
          console.log(tenant_nationality_Value, "tenant_nationality_Value....")
    ...
    identity_number_leaseholder: yup.string().test({
      ...
      test(value, ctx) {
        if (tenant_type_of_contractValueId == "0") {
          ...
          setValue('identity_number_leaseholder', value)
    ...
    identity_number_systematic_leaseholder: yup.string().test({
      ...
      test(value, ctx) {
        if (tenant_type_of_contractValueId == "1") {
          ...
          setValue('identity_number_systematic_leaseholder', value)
    ...
    identity_number_gulf_leaseholder: yup.string().test({
      ...
      test(value, ctx) {
        if (tenant_type_of_contractValueId == "2") {
          ...
          setValue('identity_number_gulf_leaseholder', value)
    ...
    try {
      if (add['current'] === true) {
        ...
        axios({
          ...
          // url: `http://127.0.0.1:8000/Contract/AddContractsAuction/`,
          data: bodyFormData,
          headers: {
        ...
        axios({
          method: "put",
          // url: `http://127.0.0.1:8000/Contract/AddContractsAuction/?id=${company_Id}`,
  ...
  const saveDataCompanynew = async (data) => {
    ...
    if (add['current'] === true) {
      ...
      // bodyFormData.append('identity_number_systematic', identity_number_systematic)
      // bodyFormData.append('identity_number_gulf', identity_number_gulf)
      bodyFormData.append('identity_number', "")
      bodyFormData.append('identity_number_systematic', "")
      bodyFormData.append('identity_number_gulf', "")
      bodyFormData.append('lease_nationality', "")
          ...
          <Form onSubmit={handleSubmit(onSubmit)}>
            <div className="container-fluid mt-5 pt-2 pb-5 mb-5 background-FFFFFF borderRadius-8">
              ...
              <Row className=' '>
                ...
                <Col sm='4' className='mb-4 form-group bmd-form-group'>
                  <SelectWithValidation1 defaultValue={type_of_AuctionValue} id_name='type_of_Auction' title='نوع المشتري' control={control} errors_check={errors.type_of_Auction} loadOptionsDB={type_of_AuctionData} change="type" />
                </Col>
