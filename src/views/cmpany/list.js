...
const Company_list = () => {
  ...
  useEffect(() => {
   ...
   if (checked === "confirmed") {
    setTypeAlert("Success")
    setTitleAlert("تم إضافة الشركة إلي القائمة السوداء بنجاح.")
    setHeadAlert("،")
    setShowAlert(true)
  } else if (checked === "canceled") {
   setTypeAlert("Success")
   setTitleAlert("تم إلغاء الشركة من القائمة السوداء بنجاح.")
   setHeadAlert("،")
   setShowAlert(true)    
  }
    ...
    <div className="theme-content px-0 px-md-5 ms-xl-5">
      ...
      <div className="container-fluid pe-md-5 ps-md-5 pe-2 ps-1">
        ...
        <Row className='container-fluid ps-4 pe-md-0 ps-md-0 mt-2'>
          ...
          <HomeHeader headerContract="نظام إدارة العقود" headerContractObj="الشركات" />
          </Col>
          {can_add_company && (
            ...
            <Col className='col-xl-6 col-12 d-flex align-items-center justify-content-md-end mt-sm-0 mt-1 pt-xl-5 pt-2  ps-xl-5 ps-2 pe-2' sm='2'>
              <Button.Ripple target='_blank' outline className="btn button1 px-xl-5 py-2" href="/addCompany">
                <span className='color-5F605F f-s-14px font-cairo f-w-700 pe-2' >إضافة شركة</span>
                <Plus className="ps-5" />
              </Button.Ripple>
            </Col>
          )}
        ...
        <div className='col-md-12 ps-md-0 ps-4   pe-0 mt-4 d-flex flex-start'>
            <div className='f-w-700 f-s-24px color-5F605F font-cairo '>قائمة الشركات</div>
