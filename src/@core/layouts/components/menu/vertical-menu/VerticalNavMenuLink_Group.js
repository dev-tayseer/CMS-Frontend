...
import '../../../../scss/react/verticaldropdownhomepage.scss'
...
const VerticalNavMenuLink_Group = ({ item, titlex, img, isChild, setMenuOpen }) => {
    ...
    return (
        <>
            <Dropdown className="dropdownsetting ps-3 pt-2"  show={isOpen} onToggle={handleToggle}>
                <Dropdown.Toggle className={`${((location.pathname == "/countries")||(location.pathname == "/cities")||(location.pathname == "/nationalities"))?  "backgroundsetting":""}`}  id="dropdown-basic2">
...
export default VerticalNavMenuLink_Group;
